...
5. 각 청크를 OpenAI STT에 보내고 결과를 병합합니다.
6. Notion 데이터 소스에 페이지를 만들고 `Voxion Transcript` 섹션 아래에 전사문을 append합니다.

청크는 현재 문장 기준이 아니라 용량 목표를 맞추기 위한 시간 구간 기준입니다. 긴 파일도 처리할 수 있도록 기본 청크 목표값은 `24_000_000` bytes로 보수적으로 잡았습니다.
